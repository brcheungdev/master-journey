...
- [`Python/src/is_prime.py`](./src/is_prime.py)    
**说明：**单点素数判定。

- [`Python/src/prime_list_1.py`](./src/prime_list_1.py)  
**说明：**基线生成器（试除法）。

- [`Python/src/prime_list_2.py`](./src/prime_list_2.py) 
**说明：**埃氏筛，更快。

- [`Python/src/Timeit-1.py`](./src/Timeit-1.py)    
**说明：**对 `prime_list_1` 在 n=1000..10000 的 `%timeit` 基准脚本。

- [`Python/src/Timeit-2.py`](./src/Timeit-2.py) 
...
- [`Python/src/plot_graph_1-2.py`](./src/plot_graph_1-2.py)  
